...
/***/ 1901:
/*!****************************************************!*\
  !*** ./src/app/services/crud-contactos.service.ts ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CrudContactosService": () => (/* binding */ CrudContactosService)
/* harmony export */ });
...
let CrudContactosService = class CrudContactosService {
  constructor(http, storage) {
    this.http = http;
    this.storage = storage;
    this.token = null;
    this._storage = null; //this.cargarIdUsuario();
  ...
  getContactos2() {
    ...
    const URL = urlService + 'listarContactosSin.php';
  ...
  eliminarContacto(id_contacto) {
    ...
    const URL = urlService + 'eliminarContacto.php';
    return new Promise(resolve => {
  ...
  crearContacto(nombreContacto, telefonoContacto, descripcionContacto, id_usuario) {
    const data = {
    ...
    console.log(data);
    const URL = urlService + 'crearContacto.php';
    ...
    return new Promise(resolve => {
      this.http.post(URL, data, {
        ...
        var _ref2 = (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (resp) {
          ...
          console.log("SQL: " + resp['sql']); //Agregar funciones para hacer cosas aquí, dependiendo del mensaje de respuesta del servidor
  ...
  actualizar(correo, cedula, nombres, apellidos, direccion, telefono, password, idUsuario) {
    const data = {
      correo: correo,
      cedula: cedula,
      nombres: nombres,
    ...
    const URL = urlService + 'ActualizarUsuario.php';
    return new Promise(resolve => {
      this.http.post(URL, data).subscribe( /*#__PURE__*/function () {
  ...
  cargarIdUsuario() {
    ...
    return (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      _this.id_usuario = yield _this.storage.get('id_usuario');
      console.log("curd::cargarIdUsuario id_usuario" + _this.id_usuario);
    })();
  }
...
CrudContactosService.ctorParameters = () => [{
  type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__.HttpClient
}, {
  type: _ionic_storage_angular__WEBPACK_IMPORTED_MODULE_3__.Storage
}];

CrudContactosService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_5__.Injectable)({
  providedIn: 'root'
})], CrudContactosService);
...
/***/ 8108:
/*!*****************************************************!*\
  !*** ./src/app/services/herramientas-ui.service.ts ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "HerramientasUIService": () => (/* binding */ HerramientasUIService)
/* harmony export */ });
/* harmony import */ var _Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 1670);
...
let HerramientasUIService = class HerramientasUIService {
  constructor(alertController) {
    this.alertController = alertController;
  }

  mostrarAlerta(encabezado, mensaje) {
    var _this = this;
...
HerramientasUIService.ctorParameters = () => [{
  type: _ionic_angular__WEBPACK_IMPORTED_MODULE_1__.AlertController
}];

HerramientasUIService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([(0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)({
  providedIn: 'root'
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_4d272360_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,_Applications_XAMPP_xamppfiles_htdocs_CSICliente_csiapp_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
